...
const steps = [
  ...
  {
    title:
      "Оформите банковскую гарантию и получите комиссионное вознаграждение",
    desc: "Всё онлайн — без посещения офиса.",
    lottie: "/login.json",
  },
];

export default function GuaranteeHowItWorksSection() {
    ...
    <section className="mx-auto max-w-7xl px-4 sm:px-6 py-12">
      ...
      <div className="relative overflow-hidden rounded-3xl sm:rounded-4xl border border-foreground/10">
        <div className="relative grid gap-10 sm:gap-12 px-4 py-10 sm:px-10 sm:py-14 lg:grid-cols-[1.05fr_0.95fr]">
          ...
          <div
            className="relative h-[200px] xs:h-[240px] sm:h-[300px] md:h-[550px] order-2 lg:order-0"
            onMouseEnter={() => setPaused(true)}
            onMouseLeave={() => setPaused(false)}
          >
