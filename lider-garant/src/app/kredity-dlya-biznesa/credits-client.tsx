...
const defaultPopularSearchTerms = [
  { text: "кредитная линия", href: "/kreditnaya-liniya" },
  { text: "оборотный кредит", href: "/oborotniy-kredit" },
  { text: "коммерческий кредит", href: "/kommercheskiy-kredit" },
  { text: "Кредит на развитие", href: "/kredit-na-razvitie" },
  { text: "кредиты мал бизнесу", href: "/kredity-mal-biznesu" },
  { text: "кредит среднему бизнесу", href: "/kredit-srednemu-biznesu" },
  { text: "кредит для ип", href: "/kredit-dlya-ip" },
  { text: "кредит для ооо", href: "/kredit-dlya-ooo" },
  { text: "кредит для юридических лиц", href: "/kredit-dlya-uridicheskih-lic" },
  { text: "кредит на оборотные средства", href: "/kredit-na-oborotnye-sredstva" },
  { text: "кредит на пополнение оборотных средств", href: "/kredit-na-popolnenie-oborotnyh-sredstv" },
  { text: "кредит для бизнеса без залога", href: "/kredit-dlya-biznesa-bez-zaloga" },
  { text: "кредит под залог коммерческой недвижимости", href: "/kredit-pod-zalog-kommercheskoy-nedvigimosti" },
  { text: "кредит на проект", href: "/kredit-na-proekt" },
  { text: "Кредит для инвестиционных проектов", href: "/kredit-dlya-investicionnih-proektov" },
  { text: "кредит коммерческим организациям", href: "/kredit-kommercheskim-organizaciyam" },
  { text: "финансовый коммерческий кредит", href: "/finansoviy-kommercheskiy-kredit" },
  { text: "коммерческие кредиты предприятиям", href: "/kommercheskie-kredity-predpriyatiyam" },
  { text: "кредит под предприятие", href: "/kredit-pod-predpriyatie" },
  { text: "банковские кредиты предприятиям", href: "/bankovskie-krediry-predpriyatiyam" },
  { text: "финансовые кредиты предприятию", href: "/finansovye-kredity-predpriyatiyu" },
  { text: "кредит для предприятия", href: "/kredit-dlya-predpriyatiya" },
  { text: "привлечение кредита предприятием", href: "/privlechenie-kredita-predpriyatiem" },
  { text: "кредит под производство", href: "/kredit-pod-proizvodstvo" },
  { text: "Кредит на развитие производства", href: "/kredit-na-razvitie-proizvodstva" },
  { text: "кредит на завод", href: "/kredit-na-zavod" },
  { text: "сельхоз кредит", href: "/selhoz-kredit" },
  { text: "кредит для селлеров", href: "/kredit-dlya-sellerov" },
  { text: "кредиты на туризм", href: "/kredity-na-turizm" },
  { text: "ипотека на коммерческую недвижимость", href: "/ipoteka-na-kommercheskuyu-nedvigimost" },
  { text: "коммерческая ипотека", href: "/ipoteka-na-kommercheskuyu-nedvijimost" },
  { text: "льготный кредит бизнесу", href: "/lgotniy-kredit-biznesu" },
];
  ...
  const onSubmit: SubmitHandler<FormData> = async (data) => {
    try {
      const result = await submitLead({
        ...
        product_type: "corporate_credit",
        source: "website_form",
        form_name: "credit_form",
      });
