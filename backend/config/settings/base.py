"""
Django base settings for Lider Garant project.
"""
import os
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'lider_garant'),
...
# Default charset for file encoding
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Lider Garant API',
    'DESCRIPTION': 'Financial SaaS Dashboard API for loan/guarantee applications',
    'VERSION': '1.0.0',
